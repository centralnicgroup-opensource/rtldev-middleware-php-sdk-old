...
class Util
{
     ...
     */
    public static function commandEncode($commandarray)
    {
     ...
     */
    public static function responseToHash($response)
    {
     ...
     */
    public static function responseToListHash($response)
    {
